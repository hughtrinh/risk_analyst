...
def _00301_stg_transactions(etl_date: str):
    spark = None

    try:
        spark = create_spark_session(
            "_00301_stg_transactions"
        )
        ...
        print("Dữ liệu đọc từ bảng transactions:")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="_00301_stg_transactions"
    )
    ...
    success = _00301_stg_transactions(
